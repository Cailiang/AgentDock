...
> AgentDock `0.1.11` 仍处于早期预览阶段。使用供应商切换或 MCP 同步前，请保留重要客户端配置的备份。
...
完成平台签名的稳定安装包将发布在 [Releases](https://github.com/Cailiang/AgentDock/releases) 页面。在此之前，可以从成功的 [Desktop Build](https://github.com/Cailiang/AgentDock/actions/workflows/desktop-build.yml) 工作流中下载 Windows、macOS 和 Linux 预览包。
